...
<div class="fy-text-center">
  <a href="universities/" class="fy-btn">查看全部大学 →</a>
</div>
...
<div class="fy-case-card">
  ...
  <a href="cases/earlier/宋泽熙-中央民族大学/" class="fy-case-card-link">阅读全文 →</a>
</div>
<div class="fy-case-card">
  <div class="fy-case-card-header">
    <div class="fy-case-card-avatar">G</div>
...
<div class="fy-text-center">
  <a href="cases/" class="fy-btn">查看全部案例 →</a>
</div>
...
<div class="fy-quote-section">
  <p class="fy-quote-text">
    "不要因为来自小地方，<br>就默认自己看不到更大的世界。"
  </p>
  <p class="fy-quote-author">—— 一位 2025 届学长</p>
</div>

<div class="fy-quote-section" style="margin-top: 16px;">
  <p class="fy-quote-text">
    "真正限制人的，<br>往往不是分数，<br>而是对世界想象力的边界。"
  </p>
  <p class="fy-quote-author">—— 一位 2024 届学姐</p>
</div>
...
<div style="display: flex; gap: 12px; margin: 12px 0; flex-wrap: wrap;">
  <div style="text-align: center;">
    <img src="assets/images/qq-group-qrcode.jpg" alt="QQ 群二维码" style="width: 100px; border-radius: 8px; border: 1px solid var(--feiyue-card-border);">
    <p style="font-size: 0.78rem; color: var(--feiyue-text-muted); margin-top: 4px;">QQ 群：793634202</p>
  </div>
  <div style="text-align: center;">
    <img src="assets/images/wechat-group-qrcode.jpg" alt="微信群二维码" style="width: 100px; border-radius: 8px; border: 1px solid var(--feiyue-card-border);">
    <p style="font-size: 0.78rem; color: var(--feiyue-text-muted); margin-top: 4px;">微信群</p>
  </div>
</div>
...
这个网站属于每一位曾经、正在、将要走出州民中的你。

如果你已经毕业，你的经验对后来者来说弥足珍贵。  
如果你是在校生，欢迎来这里看看未来的可能性。  
如果你即将毕业，请考虑在入学后回来分享你的故事。

<div style="margin-top: 32px;">
  <a href="contribute/" class="fy-btn fy-btn-primary">📝 分享你的故事</a>
  &nbsp;
  <a href="about/" class="fy-btn">了解更多</a>
</div>
